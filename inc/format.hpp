...
namespace fmt
{
    ...
    /**
     * Adapts a formatter into a new formatter. This allows formatters to be used
     * as helpers for new formatters built upon.
    ...
    {
        return &internal::fmt::format(fmtstr, formatter_g<T>().parse(args)...);
    }
    ...
    {
        fputs(&internal::fmt::format(fmtstr, formatter_g<T>().parse(args)...), file);
    }
