...
namespace museqa
{
    ...
    {
        /**
         * The representation of a coordinate system for a generic D-dimensional
         * space. Due to the arbitrary number of dimensions, there are no special
        ...
        /**
         * The representation of a coordinate system for a generic 1-dimensional
         * space. As an 1-dimensional value is a scalar, such coordinate system
         * can be interpreted seamlessly converted to its scalar type.
        ...
        /**
         * The representation of a coordinate system for a generic 2-dimensional
         * space. At this dimensionality, the coordinates in the system might be
         * referred to as or named with different 2-letter combinations.
         * @tparam T The type for the coordinate dimension's value.
         * @since 1.0
         */
        template <typename T>
        ...
        /**
         * The representation of a coordinate system for a generic 3-dimensional
         * space. At this dimensionality, the coordinates in the system might be
         * referred to as or named with different 3-letter combinations.
         * @tparam T The type for the coordinate dimension's value.
         * @since 1.0
         */
        template <typename T>
    ...
    #if !defined(MUSEQA_AVOID_REFLECTION)
    /**
     * Explicitly defines the reflector for a coordinate. Although a trivial type,
     * a coordinate cannot be automatically reflected over due to its internal union.
...
/**
 * Implements a string formatter for a generic coordinate type, thus allowing coordinates
 * to be seamlessly printed as well as scalar types.
 * @tparam D The coordinate's dimensionality.
 * @tparam T The coordinate's dimensions' type.
 * @since 1.0
 */
template <size_t D, typename T>
class fmt::formatter<museqa::geometry::coordinate<D, T>>
{
  private:
