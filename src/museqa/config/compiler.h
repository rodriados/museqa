...
#define MUSEQA_HOST_COMPILER_CLANG   2
#define MUSEQA_HOST_COMPILER_INTEL   3
...
#define MUSEQA_DEVICE_COMPILER_CLANG   2
#define MUSEQA_DEVICE_COMPILER_NVCC    3
 ...
 */
#if defined(__ICC)
  #define MUSEQA_HOST_COMPILER MUSEQA_HOST_COMPILER_INTEL
  #define MUSEQA_ICC_VERSION __INTEL_COMPILER
#elif defined(__clang__)
  #define MUSEQA_HOST_COMPILER MUSEQA_HOST_COMPILER_CLANG
...
#elif MUSEQA_HOST_COMPILER == MUSEQA_HOST_COMPILER_CLANG
  #if defined(__CUDA__)
    #define MUSEQA_DEVICE_COMPILER MUSEQA_DEVICE_COMPILER_NVCC
  #else
    #define MUSEQA_DEVICE_COMPILER MUSEQA_DEVICE_COMPILER_CLANG
  #endif
#else
 ...
 */
  ...
  #if (MUSEQA_HOST_COMPILER == MUSEQA_HOST_COMPILER_CLANG)
 ...
 * clang. This is useful for hiding buggy compiler warnings or compiler exploits
 * that have intentionally been taken advantage of.
 */
#if (MUSEQA_HOST_COMPILER == MUSEQA_HOST_COMPILER_CLANG) && !defined(__CUDA_ARCH__)
